...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  // 1ページ目かどうか、最後のページかどうかを算出プロパティで表現
  computed: {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    onFileChange: function onFileChange(event) {
      ...
      var reader = new FileReader(); // ファイルを読み込み終わった時に実行する処理
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 5:
                ...
                _this2.loading = false; // バリデーションエラーはエラーメッセージを表示する関係から、値をクリアしたりフォームを閉じる前にreturn falseで処理を中断
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 6:
                ...
                その中の写真一覧を呼び出すことができる
                */
                _this.photos = response.data.data; // データ変数にレスポンスの該当する値を記入
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 8:
              // 失敗したらfalse
              context.commit('setApiStatus', false); // バリデーションエラーの場合はルートコンポーネントに制御を渡さない
